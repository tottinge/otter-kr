...
- **Admitted:** class/dataclass declarations, annotated carrier-parameter bindings, direct field
  ...
  repeated direct comparison, arithmetic, and zero/one-positional-argument field-call rules
  normalized by their structural operands.
- **Still rejected:** semantic ownership, boundary classification, confidence scores, candidate
  ...
  normalization, formatting, or derivation rule shapes.
